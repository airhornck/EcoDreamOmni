    ...
    if task_id:
        ...
        if r.status_code == 200:
            ...
            log("B", "TC-B4 content_format 注入上下文", "PASS",
                f"task.content_format={cf}, status={task_detail['status']}")
        else:
    ...
    if not task_id:
        ...
        if r2.status_code == 201:
            ...
            for i in range(30):
                ...
                if r.status_code == 200 and r.json()["status"] == "human_wait":
                    break
            # REJECT
                ...
                if r.status_code == 200:
                    ...
                    if r.status_code == 200:
                        ...
                        if final["status"] == "completed":
                            ...
                            log("E", "TC-E1 发布完成", "FAIL", f"状态={final['status']}")
                else:
